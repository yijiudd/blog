...
<br/>
<br/>
So I started as a front-end engineer at *2021.7* after I graduated from [<u>*BUPT*</u>](https://en.wikipedia.org/wiki/Beijing_University_of_Posts_and_Telecommunications). Most of the development projects I participate in were for Apps under Bytedance, such as [<u>*JueJin*</u>](https://juejin.cn/app), and [<u>*Douyin*</u>](https://www.douyin.com/). Still making H5 games, but I started to be exposed to front-end development. Not only used game engines but also used the framework([<u>*React*</u>](https://react.dev/)) to write some UI. The feeling that I learned more about knowledge and skills for development was really good.
<br/>
<br/>
